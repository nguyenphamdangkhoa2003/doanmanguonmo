<div>
    <div>
        <div class="lg:h-auto pb-4">
            <div class="sm:min-w-full">
                <div class="relative overflow-hidden">
                    <div class="h-64 lg:h-[350px] w-full bg-cover bg-center"
    ...
    <div class="lg:py-12 py-4">
        <div>
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <section aria-labelledby="products-heading" class="lg:pb-10 pb-2 lg:pt-6">
                                    ...
                                    <div
                                        ...
                                        <div class="lg:col-span-2">
                                            <figure class="lg:h-full h-56">
                                                <x-mary-carousel
                                                    class="rounded-none rounded-tl-xl lg:rounded-tr-none rounded-tr-lg lg:rounded-bl-xl h-full w-full"
                                        ...
                                        <div class="lg:col-span-3">
                                            <div class="card-body p-5 h-full">
                                                ...
                                                <p class="text-sm text-gray-400 truncate max-w-sm">
                                                ...
                                                <div class="card-actions justify-end w-full md:flex !block">
                                                    <x-mary-form class="!gap-0 w-full"
                                                        wire:submit="selected({{ $type_room->id }})">

                                                        <x-slot:actions class="md:flex !block">
